...
//import java.java.util.concurrent.{Callable, Executors}
//
...
//  // pass in a java.java.util.function that returns a value and receive a java.java.util.function
//  // that returns the value.   The actual java.java.util.function may be executed on another thread.
...
//    }
//
//    // This helper java.java.util.function will compute the value stored at index (row,col) in the resulting matrix and place
...
//        def call(): A = {
//
//          Console.println("Executing java.java.util.function on thread: " + Thread.currentThread.getName)
//          println(func.getClass)
//          func()
//        }
//      })
//      // Create a java.java.util.function that will block when called and wait for the defered thread to finish execution.
