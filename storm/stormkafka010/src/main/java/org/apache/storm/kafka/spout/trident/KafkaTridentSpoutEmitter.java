...
import org.apache.storm.kafka.spout.trident.KafkaTridentSpoutOpaqueCoordinator;
...
public class KafkaTridentSpoutEmitter<K, V> implements IOpaquePartitionedTridentSpout.Emitter<
    ...
    private static final Logger LOG = LoggerFactory.getLogger(org.apache.storm.kafka.spout.trident.KafkaTridentSpoutEmitter.class);
