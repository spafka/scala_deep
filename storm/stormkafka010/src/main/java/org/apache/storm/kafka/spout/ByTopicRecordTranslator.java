...
public class ByTopicRecordTranslator<K, V> implements RecordTranslator<K, V> {
     ...
     */
    public org.apache.storm.kafka.spout.ByTopicRecordTranslator<K, V> forTopic(String topic, Func<ConsumerRecord<K, V>, List<Object>> func, Fields fields) {
     ...
     * @throws IllegalArgumentException if the Fields for the stream this emits to do not match any already configured Fields for the same stream
     */
    public org.apache.storm.kafka.spout.ByTopicRecordTranslator<K, V> forTopic(String topic, Func<ConsumerRecord<K, V>, List<Object>> func, Fields fields, String stream) {
     ...
     * @throws IllegalArgumentException if the Fields for the stream this emits to do not match any already configured Fields for the same stream
     */
    public org.apache.storm.kafka.spout.ByTopicRecordTranslator<K, V> forTopic(String topic, RecordTranslator<K,V> translator) {
