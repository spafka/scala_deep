...
public class KafkaBolt<K, V> extends BaseTickTupleAwareRichBolt {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(org.apache.storm.kafka.bolt.KafkaBolt.class);
    ...
    public org.apache.storm.kafka.bolt.KafkaBolt<K,V> withTupleToKafkaMapper(TupleToKafkaMapper<K,V> mapper) {
        this.mapper = mapper;
        return this;
    }
     ...
     * @return this
     */
    public org.apache.storm.kafka.bolt.KafkaBolt<K, V> withTopicSelector(String topic) {
        return withTopicSelector(new DefaultTopicSelector(topic));
    }
    
    public org.apache.storm.kafka.bolt.KafkaBolt<K,V> withTopicSelector(KafkaTopicSelector selector) {
        this.topicSelector = selector;
        return this;
    }

    public org.apache.storm.kafka.bolt.KafkaBolt<K,V> withProducerProperties(Properties producerProperties) {
