...
public class TridentKafkaStateFactory<K, V> implements StateFactory {
    ...
    public org.apache.storm.kafka.trident.TridentKafkaStateFactory<K, V> withTridentTupleToKafkaMapper(TridentTupleToKafkaMapper<K, V> mapper) {
        this.mapper = mapper;
        return this;
    }

    public org.apache.storm.kafka.trident.TridentKafkaStateFactory<K, V> withKafkaTopicSelector(KafkaTopicSelector selector) {
        this.topicSelector = selector;
        return this;
    }

    public org.apache.storm.kafka.trident.TridentKafkaStateFactory<K, V> withProducerProperties(Properties props) {
