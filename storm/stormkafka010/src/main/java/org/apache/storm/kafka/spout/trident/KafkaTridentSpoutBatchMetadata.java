...
public class KafkaTridentSpoutBatchMetadata implements Serializable {
    private static final Logger LOG = LoggerFactory.getLogger(org.apache.storm.kafka.spout.trident.KafkaTridentSpoutBatchMetadata.class);
     ...
     */
    public static org.apache.storm.kafka.spout.trident.KafkaTridentSpoutBatchMetadata fromMap(Map<String, Object> map) {
        ...
        return new org.apache.storm.kafka.spout.trident.KafkaTridentSpoutBatchMetadata(tp, ((Number)map.get(FIRST_OFFSET_KEY)).longValue(),
